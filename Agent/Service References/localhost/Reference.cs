...
namespace Agent.localhost {
    ...
    public interface IWallstreetDataService {
        ...
        Agent.localhost.InvestorDepot LoginInvestor(Agent.localhost.Registration registration);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWallstreetDataService/LoginInvestor", ReplyAction="http://tempuri.org/IWallstreetDataService/LoginInvestorResponse")]
        System.Threading.Tasks.Task<Agent.localhost.InvestorDepot> LoginInvestorAsync(Agent.localhost.Registration registration);
        ...
        Agent.localhost.FundDepot LoginFund(Agent.localhost.FundRegistration registration);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWallstreetDataService/LoginFund", ReplyAction="http://tempuri.org/IWallstreetDataService/LoginFundResponse")]
        System.Threading.Tasks.Task<Agent.localhost.FundDepot> LoginFundAsync(Agent.localhost.FundRegistration registration);
        ...
        Agent.localhost.FirmDepot RegisterFirm(Agent.localhost.Request request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWallstreetDataService/RegisterFirm", ReplyAction="http://tempuri.org/IWallstreetDataService/RegisterFirmResponse")]
        System.Threading.Tasks.Task<Agent.localhost.FirmDepot> RegisterFirmAsync(Agent.localhost.Request request);
    ...
    public partial class WallstreetDataServiceClient : System.ServiceModel.DuplexClientBase<Agent.localhost.IWallstreetDataService>, Agent.localhost.IWallstreetDataService {
        ...
        public Agent.localhost.InvestorDepot LoginInvestor(Agent.localhost.Registration registration) {
            return base.Channel.LoginInvestor(registration);
        }
        
        public System.Threading.Tasks.Task<Agent.localhost.InvestorDepot> LoginInvestorAsync(Agent.localhost.Registration registration) {
            return base.Channel.LoginInvestorAsync(registration);
        }
        
        public Agent.localhost.FundDepot LoginFund(Agent.localhost.FundRegistration registration) {
            return base.Channel.LoginFund(registration);
        }
        
        public System.Threading.Tasks.Task<Agent.localhost.FundDepot> LoginFundAsync(Agent.localhost.FundRegistration registration) {
        ...
        public Agent.localhost.FirmDepot RegisterFirm(Agent.localhost.Request request) {
            return base.Channel.RegisterFirm(request);
        }
        
        public System.Threading.Tasks.Task<Agent.localhost.FirmDepot> RegisterFirmAsync(Agent.localhost.Request request) {
    ...
    public interface IBrokerServiceCallback {
        ...
        Agent.localhost.FirmRequestResult OnNewRegistrationRequestAvailable(Agent.localhost.Request request);
        ...
        Agent.localhost.OrderMatchResult OnNewOrderMatchingRequestAvailable(Agent.localhost.Order order, Agent.localhost.Order[] orders);
    }
