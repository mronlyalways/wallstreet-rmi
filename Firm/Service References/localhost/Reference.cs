...
namespace Firm.localhost {
    ...
    public interface IWallstreetDataService {
        ...
        Firm.localhost.FundDepot LoginFund(Firm.localhost.FundRegistration registration);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWallstreetDataService/LoginFund", ReplyAction="http://tempuri.org/IWallstreetDataService/LoginFundResponse")]
        System.Threading.Tasks.Task<Firm.localhost.FundDepot> LoginFundAsync(Firm.localhost.FundRegistration registration);
    ...
    public partial class WallstreetDataServiceClient : System.ServiceModel.DuplexClientBase<Firm.localhost.IWallstreetDataService>, Firm.localhost.IWallstreetDataService {
        ...
        public Firm.localhost.FundDepot LoginFund(Firm.localhost.FundRegistration registration) {
            return base.Channel.LoginFund(registration);
        }
        
        public System.Threading.Tasks.Task<Firm.localhost.FundDepot> LoginFundAsync(Firm.localhost.FundRegistration registration) {
    ...
    public interface IBrokerServiceCallback {
        ...
        Firm.localhost.FirmRequestResult OnNewFirmRegistrationRequestAvailable(Firm.localhost.FirmRegistration request);
        ...
        Firm.localhost.FundRequestResult OnNewFundRegistrationRequestAvailable(Firm.localhost.FundRegistration request);
